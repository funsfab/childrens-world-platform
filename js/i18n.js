(function(){
  ...
  const fr={
    ...
    'Draw it, colour it, move parts around, test it, improve it and make the design your own.':'Dessine, colorie, déplace des éléments, teste, améliore et crée ton propre design.',
    'DRAW • DESIGN • TEST':'DESSINER • CONCEVOIR • TESTER','YOUR DESIGN':'TON DESIGN','Draw it for real.':'Dessine-le vraiment.','Create, test, improve.':'Crée, teste, améliore.','The faint blueprint is only a starting guide. Trace it, change it or switch the template off and create freely.':'Le modèle pâle n’est qu’un point de départ. Suis-le, transforme-le ou désactive-le pour créer librement.','Pencil':'Crayon','Eraser':'Gomme','Blueprint on':'Modèle activé','Undo':'Annuler','Redo':'Rétablir','Remove part':'Supprimer l’élément','Test my creation':'Tester ma création','Save project':'Enregistrer le projet','Clear this project':'Effacer ce projet','Optional design notes and decisions':'Notes et décisions facultatives','Add a note about your idea, what you changed, or what you want to improve next...':'Ajoute une note sur ton idée, ce que tu as changé ou ce que tu veux améliorer ensuite...',
    ...
    'Reach Education 50+':'Atteindre Éducation 50+','Finish with £30k–£70k reserve':'Finir avec une réserve de 30k–70k £',
    'Use your £2,350,000 budget wisely. Reach 5,000 people, provide every essential service, raise Education to at least 50, and finish with a careful £30,000–£70,000 emergency reserve.':'Utilise intelligemment ton budget de 2 350 000 £. Atteins 5 000 habitants, fournis tous les services essentiels, monte l’Éducation à au moins 50 et termine avec une réserve d’urgence prudente de 30 000–70 000 £.',
    'Start with enough homes, but remember: simply placing one of everything will not be enough. Strong services and a sensible emergency reserve matter too.':'Commence avec assez de logements, mais placer simplement un exemplaire de chaque service ne suffira pas. Des services solides et une réserve d’urgence raisonnable comptent aussi.',
    'MISSION WORKSPACE':'ESPACE DE MISSION','MISSION BRIEF':'BRIEF DE MISSION','Plan before you build.':'Planifie avant de construire.','YOUR PROJECT':'TON PROJET','Build the idea step by step.':'Construis ton idée étape par étape.','Save & continue':'Enregistrer et continuer','Clear this draft':'Effacer ce brouillon','← Mission list':'← Liste des missions','Next question →':'Question suivante →','Start Again from Explorer':'Recommencer depuis Explorateur','Play Master Mission Again':'Rejouer la Mission Maître',
    'There is no single correct design. Your job is to explain your choices and improve the idea.':'Il n’y a pas une seule bonne conception. Ton rôle est d’expliquer tes choix et d’améliorer ton idée.','Sketch your idea in words here...':'Décris ton idée avec tes mots ici...','Creative mission':'Mission créative',
    '1 • CHOOSE A DESIGN MODE':'1 • CHOISIS UN MODE DE CONCEPTION','What are you working on first?':'Sur quoi veux-tu travailler d’abord ?','Choose a category to load the right tools and parts.':'Choisis une catégorie pour charger les bons outils et éléments.','2 • YOUR DESIGN':'2 • TON DESIGN','Line':'Ligne','Rectangle':'Rectangle','Circle':'Cercle','Grid off':'Grille désactivée','Brush size':'Taille du pinceau','Select a movable part to edit it':'Sélectionne un élément déplaçable pour le modifier','Resize, rotate, duplicate or change its layer.':'Redimensionne, tourne, duplique ou change son calque.','Object size':'Taille de l’objet','Rotate':'Rotation','Duplicate':'Dupliquer','Back':'Arrière','Front':'Avant','Remove':'Supprimer','PROTECT YOUR WORK':'PROTÈGE TON TRAVAIL','Clear this project?':'Effacer ce projet ?','This will remove the current drawing, movable parts and notes. This cannot be undone after you confirm.':'Cela supprimera le dessin actuel, les éléments déplaçables et les notes. Cette action est irréversible après confirmation.','Keep my project':'Garder mon projet','Clear project':'Effacer le projet'
